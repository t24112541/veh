            ...
            <v-stepper v-model="ms_step">
              ...
              <v-stepper-items>
                ...
                <v-stepper-content step="2">
                  <v-flex text-xs-center xs12 style="color:#81c784"><i class="fas fa-clock fa-2x" ></i></v-flex>
                  <v-flex text-xs-center xs12 style="color:#81c784">รอการตรวจสอบ</v-flex>
                </v-stepper-content>
    ...
    export default {
        ...
        data(){
          return{
            ...
            link_img:"http://localhost:34001/img/object_control/",
        ...
        methods:{
          ...
          async object_control_del(){//console.log("object_control_del")
            ...
            if(res.data.ok==true){
              ...
              this.$router.push({name:"student-object_control"})
            }
