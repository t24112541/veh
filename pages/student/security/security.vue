    ...
    <v-card>
      ...
      <v-tabs-items v-model="tabs" class="white elevation-1">
        ...
        >
          ...
          <v-layout row wrap>
            <v-flex xs12 ><div class="cv-title">เปลี่ยน Username</div></v-flex>
            <v-flex xs12 >
              <v-layout align-center>
                <v-text-field
                  :rules="[rules.required]"
                  label="username"
                  v-model="std_username"
        ...
        >
          <v-container grid-list-sm class="pa-4">
          <v-layout row wrap>
            <v-flex xs12 ><div class="cv-title">เปลี่ยน Password</div></v-flex>
            <v-flex xs12 >
              <v-layout align-center>
                <v-text-field
                  :append-icon="old_stg_password ? 'visibility' : 'visibility_off'"
    ...
    export default {
        ...
        methods:{
            async sh_profile(){
              ...
              this.std_username=res.data.datas[0].std_username           
            },
