...
<script>
  export default {
    ...
    computed:{
      ...
      //     if(this.datas[i].ac_name+''===this.txt_search || this.datas[i].std_code+''!==this.txt_search || this.datas[i].std_name+''!==this.txt_search){
      //       sh.push(this.datas[i])
      //     }
      //   }
      //   return sh
      // },
    ...
    async created(){
      if(this.$route.query.g_code){
        ...
        let res=await this.$http.post('/accessories/sh_accessories_w_std',{std_id:sessionStorage.getItem("std_code")})
        this.datas=res.data.datas
        this.state=false
