...
<script>
  export default {
    ...
    async created(){
        ...
        let res=await this.$http.post('/machine/sh_machine_w_std',{std_id:sessionStorage.getItem("id")})
    ...
    methods:{
      list_machine(mc_id){
        this.$router.push({path: '../student/machines/edit_machine?mc_id='+mc_id})
      },
     machine_add(){
        this.$router.push({path:"../student/machines/data_add_machine"})
      }
    }
  }
</script>