        ...
        methods:{ 
           async machine_add(){
            if(this.mc_code!='' && this.mc_brand!=''&& this.mc_series!=''&&this.img_font!=''&&this.img_side!=''&&this.img_rear!=''){
              ...
              formData.append('std_id',sessionStorage.getItem("std_code"))
              formData.append('u_id',sessionStorage.getItem("std_code"))
              formData.append('u_table',"pk_machine")
              formData.append('mc_u_table',sessionStorage.getItem("status"))
              ...
              if(res.data.ok==true){
                this.$router.push({name:"student-machines-data_add_machine"})
                this.load_status=0
