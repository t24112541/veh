...
module.exports = {
  ...
  head: {
    ...
    link: [
      { rel: 'shortcut icon', href: './veh.PNG' },
      { rel: 'apple-touch-icon', sizes: '180x180', href: './veh.PNG' },
      { rel: 'icon', type: 'image/png', sizes: '32x32', href: './veh.PNG' },
      { rel: 'icon', type: 'image/png', sizes: '16x16', href: './veh.PNG' },
      { rel: 'mask-icon', href: './veh.PNG', color: '#5bbad5' },
      { name: 'msapplication-TileColor', content: '#da532c' },
